...
posts_data = [
    ...
    {"id": 7,   "title": "셔틀버스 광주캠 노선 예약 마감 시간 몇 시까지임?", "content": "맨날 통학버스 앱으로 예약하다가 깜빡했는데 전날 몇 시까지 예약 마감인가요? 지금 들어가니까 예약 버튼이 안 눌려서 조마조마하네요 대중교통 타야 하나요...", "createdAt": "2026-05-16T15:30:22.887Z", "authorId": 84, "viewCount": 290, "likeCount": 4, "commentCount": 12, "category": "free"},
